...
```bash
curl -X POST http://localhost:8080/api/v1/execute/reagent.demo_echo \
...
```bash
curl -X POST http://localhost:8080/api/v1/execute/reagent.demo_analyze_sentiment \
  -H "Content-Type: application/json" \
...
Created by VictorEzealor (vic.ezealor@gmail.com) on 2026-05-15 01:49:16 UTC
